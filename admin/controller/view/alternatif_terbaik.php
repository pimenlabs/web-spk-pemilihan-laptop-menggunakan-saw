    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen alternatif terbaik kategori <?php echo $_SESSION['kategori']; ?></b></li>
      </ul>
...
$dd = mysql_query("select * from ranging where nilai='$data'");
$f=0; 
                while ($puser = mysql_fetch_array($dd)) {
                 $f++; 
                 ?>
                <tr class="gradeX">
                  <td><?php echo $f; ?></td>
