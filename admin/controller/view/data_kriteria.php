    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Data Kriteria</b></li>
      </ul>
        ...
        <div class="block-border">
          ...
          <div class="block-content">
           <table id="table-example" class="table">
              ...
              <tbody>
                <?php 
                  $muser = mysql_query("select * from kriteria");
                ...
                <td><?php echo $puser['c5']; ?></td>
                  ...
                  <td><a href="main.php?id=edata_kriteria&tipe_laptop=<?php echo $puser['tipe_laptop']; ?>">Edit</a> 
                    | <a href="controller/delete/ddata_kriteria.php?ddata_kriteria=<?php echo $puser['tipe_laptop']; ?>">Hapus</a></td>
